 ...
 */
/*
Plugin Name: Cart2Cart: Pinnacle Cart to WooCommerce Migration Module
...
function cart2cart_config(){
	...
	$sourceCartName = 'Pinnacle Cart';
  $sourceCartId = 'Pinnacle361';
	$referertext = 'Cart2Cart: '. $sourceCartName  . ' to '. $cartName  . ' module';
	$sourceCartLogo = 'http://www.shopping-cart-migration.com/images/stories/pinnacle.gif';
